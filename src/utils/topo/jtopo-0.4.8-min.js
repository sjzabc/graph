...
function (a) {
  function b(a) {
    return {
      ...
      getData: function (b, c) {
        ...
        null != j && null != k ? this.setSize(b, c) : this.setSize(0, 0);
  ...
  function c(c) {
    ...
    q.forEach(function (a) {
      ...
      function () {  
        0 == n.frames ? setTimeout(arguments.callee, 100) : n.frames < 0 ? (n.repaint(), setTimeout(arguments.callee, 1e3 / -n.frames)) : (n.repaint(), setTimeout(arguments.callee?arguments.callee:()=>{}, 1e3 / n.frames))
      }(), setTimeout(function () { 
...
function (a) {
  function b(c) {
    this.initialize = function (c) {
      ...
      this.paintText(a), this.paintBorder(a), this.paintCtrl(a), this.paintAlarmText(a), this.paintTriangle(a)
      ...
      if (this.inTriangle) {
        ...
        var e = 0;
        var f = -this.width / 2;
        a.moveTo(f, e), a.lineTo(f - 6, e + 4), a.lineTo(f - 6, e - 4), a.lineTo(f, e), a.fill(), a.stroke(), a.closePath();
      }
      if (this.outTriangle) {
        a.beginPath(), a.font = this.font;
        var d = a.measureText("田").width;
  ...
  function d(a) {
    this.initialize(), this.text = a, this.elementType = "TextNode", this.paint = function (a) {
      a.beginPath(), a.font = this.font, this.width = a.measureText(this.text).width, this.height = a.measureText("田").width, a.strokeStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")", a.fillStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")", a.fillText(this.text, -this.width / 2, this.height / 2), a.closePath(), this.paintBorder(a), this.paintCtrl(a), this.paintAlarmText(a), this.paintTriangle(a)
    }
  }
  ...
  function e(a, b, c) {
    this.initialize(), this.text = a, this.href = b, this.target = c, this.elementType = "LinkNode", this.isVisited = !1, this.visitedColor = null, this.paint = function (a) {
      a.beginPath(), a.font = this.font, this.width = a.measureText(this.text).width, this.height = a.measureText("田").width, this.isVisited && null != this.visitedColor ? (a.strokeStyle = "rgba(" + this.visitedColor + ", " + this.alpha + ")", a.fillStyle = "rgba(" + this.visitedColor + ", " + this.alpha + ")") : (a.strokeStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")", a.fillStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")"), a.fillText(this.text, -this.width / 2, this.height / 2), this.isMouseOver && (a.moveTo(-this.width / 2, this.height), a.lineTo(this.width / 2, this.height), a.stroke()), a.closePath(), this.paintBorder(a), this.paintCtrl(a), this.paintAlarmText(a), this.paintTriangle(a)
  ...
  function f(a) {
    this.initialize(arguments), this._radius = 20, this.beginDegree = 0, this.endDegree = 2 * Math.PI, this.text = a, this.paint = function (a) {
      a.save(), a.beginPath(), a.fillStyle = "rgba(" + this.fillColor + "," + this.alpha + ")", a.arc(0, 0, this.radius, this.beginDegree, this.endDegree, !0), a.fill(), a.closePath(), a.restore(), this.paintText(a), this.paintBorder(a), this.paintCtrl(a), this.paintAlarmText(a), this.paintTriangle(a)
  ...
  function h(a, b, c, d, e) {
    ...
    e = e || 0, this.paint = function (a) {
      if (this.image) {
        ...
        a.drawImage(this.image, g, f, b, d, -b / 2, -d / 2, b, d), a.fill(), a.closePath(), a.restore(), this.paintText(a), this.paintBorder(a), this.paintCtrl(a), this.paintAlarmText(a), this.paintTriangle(a)
      }
    }, this.nextFrame = function () {
      if (!this.isStop) {
